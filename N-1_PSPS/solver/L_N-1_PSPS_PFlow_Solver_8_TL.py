...
model.setParam('LogFile', 'result%s/grblogL_TL%s_%s_Relax%s_N-1_PSPS_Span%s_PFlow_Lazy%s_%s_inst%s.txt'%(len(nodeArray),TL,machineName,relax,spanning,laziness,len(nodeArray),inst))   
