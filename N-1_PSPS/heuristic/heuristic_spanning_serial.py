...
def ARR(lineArray,nodeArray,inst,G,timeLimit,profiling,iteration):
    ...
    while toc - tic < timeLimit:
        ...
        if bestSolRisk > solRisk:
            ...
            listHeuristic = list(zip(sizeArray,lineSizeArray,instArray, totalDemandArray, ratioDemandRequiredArray, totalRiskArray, resultRiskArray, ratioRiskArray, timeArray, nodecountArray, machineArray, spanningArray,iterArray,TLArray))
            nameColumn = ['Nodes','Lines','inst','totalDemand','ratioDemandRequired','totalRiskArray','minRisk','ratioRisk','Time','Trial','Machine','Spanning','iter','timeLimit']
    ...
    return bestSolEdges, bestSolFunction, bestSolRisk, bestTrial, bestTime
...
bestPackage = ARR(lineArray,nodeArray,inst,G,timeLimit,profiling,iteration)                
bestSolEdges, bestSolFunction, bestSolRisk, bestTrial, bestTime = bestPackage
